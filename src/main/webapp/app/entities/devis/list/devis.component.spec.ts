...
describe('Devis Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'devis', component: DevisComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.devis?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
