...
export class DevisComponent implements OnInit {
  ...
  trackId(_index: number, item: IDevis): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IDevis[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
