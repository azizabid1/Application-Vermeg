...
export class VoteComponent implements OnInit {
  ...
  trackId(_index: number, item: IVote): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IVote[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
