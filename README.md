...
To build the final jar and optimize the VermegApp application for production, run:
...
Then navigate to [http://localhost:8050](http://localhost:8050) in your browser.
